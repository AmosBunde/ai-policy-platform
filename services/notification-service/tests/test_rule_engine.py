...
class TestContains:
    def test_string_contains(self):
        assert evaluate_condition(
            {"field": "keyword", "operator": "contains", "value": "privacy"},
            {"keyword": "data privacy regulation"},
        )

    def test_not_contains(self):
        assert not evaluate_condition(
            {"field": "keyword", "operator": "contains", "value": "crypto"},
            {"keyword": "data privacy"},
        )

    def test_case_insensitive(self):
        assert evaluate_condition(
            {"field": "keyword", "operator": "contains", "value": "GDPR"},
            {"keyword": "gdpr regulation"},
        )
...
class TestGte:
    def test_gte_true(self):
        assert evaluate_condition(
            {"field": "score", "operator": "gte", "value": 5}, {"score": 8}
        )

    def test_gte_equal(self):
        assert evaluate_condition(
            {"field": "score", "operator": "gte", "value": 5}, {"score": 5}
        )

    def test_gte_false(self):
        assert not evaluate_condition(
            {"field": "score", "operator": "gte", "value": 5}, {"score": 3}
        )
...
class TestLte:
    def test_lte_true(self):
        assert evaluate_condition(
            {"field": "score", "operator": "lte", "value": 5}, {"score": 3}
        )

    def test_lte_equal(self):
        assert evaluate_condition(
            {"field": "score", "operator": "lte", "value": 5}, {"score": 5}
        )

    def test_lte_false(self):
        assert not evaluate_condition(
            {"field": "score", "operator": "lte", "value": 5}, {"score": 8}
        )
...
class TestIn:
    def test_in_list(self):
        assert evaluate_condition(
            {"field": "jurisdiction", "operator": "in", "value": ["EU", "UK", "US"]},
            {"jurisdiction": "EU"},
        )

    def test_not_in_list(self):
        assert not evaluate_condition(
            {"field": "jurisdiction", "operator": "in", "value": ["UK", "US"]},
            {"jurisdiction": "EU"},
        )
...
class TestNotIn:
    def test_not_in(self):
        assert evaluate_condition(
            {"field": "jurisdiction", "operator": "not_in", "value": ["UK", "US"]},
            {"jurisdiction": "EU"},
        )

    def test_in_rejects(self):
        assert not evaluate_condition(
            {"field": "jurisdiction", "operator": "not_in", "value": ["EU", "UK"]},
            {"jurisdiction": "EU"},
        )
...
class TestEdgeCases:
    ...
    def test_unknown_operator_returns_false(self):
        assert not evaluate_condition(
            {"field": "jurisdiction", "operator": "regex", "value": ".*"},
            {"jurisdiction": "EU"},
        )
